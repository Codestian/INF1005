...
<section style="height: 100vh;">
    ...
    <div id="main-map">
        ...
        <map name="image-map" id="image-map">
            ...
            <area class="area" target="" alt="West-side" title="West-side" href="west"
            ...
            <area class="area" target="" alt="North-side" title="North-side" href="north"
            ...
            <area class="area" target="" alt="Central-side" title="Central-side" href="central"
            ...
            <area class="area" target="" alt="East-side" title="East-side" href="east"
